...
float: right;
margin-top: -60px;">ORDER #12313</small>
...
@component('mail::button', ['url' => ''])
    ...
    <div class="product-thumbnail__wrapper">
      <img  class="product-thumbnail__image" src="//cdn.shopify.com/s/files/1/3000/4362/products/SphereWalltones_Product_Image_1_small.jpg?v=1593540808" />
    </div>
    </div>
            </td>
            <th class="product__description" scope="row">
                <span class="product__description__name order-summary__emphasis">Moon</span>
                <span class="product__description__variant order-summary__small-text">Mohammed</span>
              </th>
            <td class="product__price">
              <span class="order-summary__emphasis skeleton-while-loading">375.00 SAR</span>
            </td>
          </tr>
        </tbody>
      </table>
